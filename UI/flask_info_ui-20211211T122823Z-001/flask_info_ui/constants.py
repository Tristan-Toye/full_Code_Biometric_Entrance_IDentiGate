...
LIST_PATH = [RESPONSE_CHECK_DATABASE,RESPONSE_LOG_DATABASE,RESPONSE_VALIDATE_QR,RESPONSE_ROLE_REQUEST_DATABASE,RESPONSE_VISITOR,REMOVED_USERS,RESPONSE_COMPARE_DATABASES]
